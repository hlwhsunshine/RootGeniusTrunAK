...
/* renamed from: com.baidu.mobads.am */
public class C0255am implements IXAdConstants {
    /* renamed from: a */
    private static String[] f416a = new String[]{"com.android.chrome", "com.UCMobile", "com.uc.browser", "com.uc.browser.hd", "com.tencent.mtt", "com.tencent.padbrowser", "com.baidu.browser.apps", "com.android.browser", "com.oupeng.mini.android", "com.oupeng.mobile", "com.oupeng.browser", "com.opera.mini.android", "com.opera.browser", "com.opera.browser.beta", "com.mediawoz.xbrowser", "com.mx.browser", "com.mx.browser.tablet", "org.mozilla.firefox", "com.tiantianmini.android.browser", "com.ijinshan.browser_fast", "sogou.mobile.explorer", "com.dolphin.browser.cn", "com.qihoo.browser", "com.baidu.searchbox"};
    ...
    public String getAppPackageNameOfPublisher() {
        return C0338m.m569a().mo5031d().getPackageName();
    }

    public String getAppSec() {
        return C0338m.m569a().mo5040m().getAppSec(C0338m.m569a().mo5031d());
    }

    public String getAppSid() {
        return C0338m.m569a().mo5040m().getAppId(C0338m.m569a().mo5031d());
    }
    ...
    public String getRemoteVersion() {
        IXAdContainerFactory c = C0338m.m569a().mo5030c();
        return c != null ? c.getRemoteVersion() : "0.0.0";
    }

    public String getSN() {
        return C0338m.m569a().mo5041n().getEncodedSN(C0338m.m569a().mo5031d());
    }
