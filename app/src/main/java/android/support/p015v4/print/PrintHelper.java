package android.support.p015v4.print;

import android.content.Context;
import android.graphics.Bitmap;
import android.net.Uri;
import android.os.Build.VERSION;
import android.support.p015v4.print.PrintHelperKitkat.OnPrintFinishCallback;
...
public final class PrintHelper {
    ...
    private static final class PrintHelperKitkatImpl implements PrintHelperVersionImpl {
        ...
        public final void printBitmap(String str, Bitmap bitmap, final OnPrintFinishCallback onPrintFinishCallback) {
            OnPrintFinishCallback onPrintFinishCallback2 = null;
            if (onPrintFinishCallback != null) {
                onPrintFinishCallback2 = new OnPrintFinishCallback() {
