package android.support.p015v4.provider;
...
class DocumentsContractApi19 {
    ...
    public static boolean canRead(Context context, Uri uri) {
        return context.checkCallingOrSelfUriPermission(uri, 1) == 0 && !TextUtils.isEmpty(DocumentsContractApi19.getRawType(context, uri));
    }
    ...
    public static boolean canWrite(Context context, Uri uri) {
        ...
        CharSequence rawType = DocumentsContractApi19.getRawType(context, uri);
        int queryForInt = DocumentsContractApi19.queryForInt(context, uri, "flags", 0);
    ...
    public static boolean exists(Context context, Uri uri) {
        ...
        try {
            ...
            try {
                ...
                DocumentsContractApi19.closeQuietly(query);
                return z;
            } catch (Exception e2) {
                e = e2;
            }
    ...
    public static String getType(Context context, Uri uri) {
        String rawType = DocumentsContractApi19.getRawType(context, uri);
    ...
    private static int queryForInt(Context context, Uri uri, String str, int i) {
        return (int) DocumentsContractApi19.queryForLong(context, uri, str, (long) i);
    }
