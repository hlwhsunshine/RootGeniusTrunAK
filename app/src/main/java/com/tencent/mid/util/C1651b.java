...
class C1651b extends C1650a {
    ...
    public C1651b(int i, byte[] bArr) {
        this.f4699a = bArr;
        this.f4705g = (i & 8) == 0 ? f4701c : f4702d;
        this.f4703e = 0;
        this.f4704f = 0;
    }
    ...
    /* renamed from: a */
    public boolean mo7668a(byte[] r10, int r11, int r12, boolean r13) {
        /*
        r9 = this;
        r0 = r9.f4703e;
        r1 = 6;
    ...
    L_0x013c:
        ...
        goto L_0x0006;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mid.util.b.a(byte[], int, int, boolean):boolean");
    }
}
