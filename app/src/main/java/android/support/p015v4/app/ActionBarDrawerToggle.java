...
import android.support.p015v4.widget.DrawerLayout;
import android.support.p015v4.widget.DrawerLayout.DrawerListener;
...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, @DrawableRes int i, @StringRes int i2, @StringRes int i3) {
        this(activity, drawerLayout, !ActionBarDrawerToggle.assumeMaterial(activity), i, i2, i3);
    }
