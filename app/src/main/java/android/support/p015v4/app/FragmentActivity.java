...
import android.support.p015v4.app.ActivityCompat.OnRequestPermissionsResultCallback;
import android.support.p015v4.app.ActivityCompatApi23.RequestPermissionsRequestCodeValidator;
import android.support.p015v4.internal.view.SupportMenu;
import android.support.p015v4.media.session.MediaControllerCompat;
import android.support.p015v4.util.SimpleArrayMap;
...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    final Handler mHandler = new C00731();
