...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00961();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00972();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    final class C00961 implements ThreadFactory {
    ...
    private static abstract class WorkerRunnable<Params, Result> implements Callable<Result> {
        ...
        /* synthetic */ WorkerRunnable(C00961 c00961) {
            this();
        }
    }

    /* renamed from: android.support.v4.content.ModernAsyncTask$2 */
    class C00972 extends WorkerRunnable<Params, Result> {
        C00972() {
            super();
        }
    ...
    protected final void publishProgress(Progress... progressArr) {
        if (!isCancelled()) {
            ModernAsyncTask.getHandler().obtainMessage(2, new AsyncTaskResult(this, progressArr)).sendToTarget();
        }
    }
}
