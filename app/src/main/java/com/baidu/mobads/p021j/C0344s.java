...
public class C0344s implements IXAdViewUtils {
    /* renamed from: a */
    private boolean m597a(View view) {
        return view.getWidth() > 15 && view.getHeight() > 15;
    }

    public int getViewState(View view) {
        return !isScreenOn(view.getContext()) ? 4 : !isAdViewShown(view) ? 1 : !m597a(view) ? 6 : !isVisible(view, 50) ? 3 : 0;
    }
    ...
    public boolean isAdViewOutsideScreen(View view) {
        ...
        Rect windowRect = C0338m.m569a().mo5040m().getWindowRect(view.getContext());
