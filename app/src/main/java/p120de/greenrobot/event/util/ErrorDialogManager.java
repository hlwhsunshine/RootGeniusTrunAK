...
public class ErrorDialogManager {
    ...
    public static class SupportManagerFragment extends android.support.p015v4.app.Fragment {
        protected Bundle argumentsForErrorDialog;
        private EventBus eventBus;
        private Object executionScope;
        protected boolean finishAfterDialog;
        ...
        public static void attachTo(Activity activity, Object obj, boolean z, Bundle bundle) {
            android.support.p015v4.app.FragmentManager supportFragmentManager = ((FragmentActivity) activity).getSupportFragmentManager();
            ...
            if (supportManagerFragment == null) {
                ...
                supportFragmentManager.beginTransaction().add((android.support.p015v4.app.Fragment) supportManagerFragment, ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER).commit();
        ...
        public void onEventMainThread(ThrowableFailureEvent throwableFailureEvent) {
            if (ErrorDialogManager.isInExecutionScope(this.executionScope, throwableFailureEvent)) {
                ErrorDialogManager.checkLogException(throwableFailureEvent);
                android.support.p015v4.app.FragmentManager fragmentManager = getFragmentManager();
                fragmentManager.executePendingTransactions();
                android.support.p015v4.app.DialogFragment dialogFragment = (android.support.p015v4.app.DialogFragment) fragmentManager.findFragmentByTag(ErrorDialogManager.TAG_ERROR_DIALOG);
                if (dialogFragment != null) {
                    dialogFragment.dismiss();
                }
                dialogFragment = (android.support.p015v4.app.DialogFragment) ErrorDialogManager.factory.prepareErrorFragment(throwableFailureEvent, this.finishAfterDialog, this.argumentsForErrorDialog);
                if (dialogFragment != null) {
                    dialogFragment.show(fragmentManager, ErrorDialogManager.TAG_ERROR_DIALOG);
                }
            }
    ...
    public static void attachTo(Activity activity, Object obj, boolean z, Bundle bundle) {
        ...
        } else if (ErrorDialogManager.isSupportActivity(activity)) {
    ...
    public static void attachTo(Activity activity, boolean z) {
        ErrorDialogManager.attachTo(activity, z, null);
    }

    public static void attachTo(Activity activity, boolean z, Bundle bundle) {
        ErrorDialogManager.attachTo(activity, activity.getClass(), z, bundle);
    }
