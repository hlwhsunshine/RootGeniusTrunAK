...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                Log.m4580e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                return wXMediaMessage;
            }
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            Log.m4580e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        private static String pathOldToNew(String str) {
            Log.m4581i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m4580e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            ...
            Log.m4580e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = " + str);
            return str;
        }
    ...
    final boolean checkArgs() {
        if (getType() == 8 && (this.thumbData == null || this.thumbData.length == 0)) {
            Log.m4580e(TAG, "checkArgs fail, thumbData should not be null when send emoji");
            return false;
        } else if (getType() == 36 && (this.thumbData == null || this.thumbData.length > 131072)) {
            Log.m4580e(TAG, "checkArgs fail, thumbData should not be null or exceed 128kb");
            return false;
        } else if (getType() != 36 && this.thumbData != null && this.thumbData.length > 32768) {
            Log.m4580e(TAG, "checkArgs fail, thumbData is invalid");
            return false;
        } else if (this.title != null && this.title.length() > 512) {
            Log.m4580e(TAG, "checkArgs fail, title is invalid");
            return false;
        } else if (this.description != null && this.description.length() > 1024) {
            Log.m4580e(TAG, "checkArgs fail, description is invalid");
            return false;
        } else if (this.mediaObject == null) {
            Log.m4580e(TAG, "checkArgs fail, mediaObject is null");
            return false;
        } else if (this.mediaTagName != null && this.mediaTagName.length() > 64) {
            Log.m4580e(TAG, "checkArgs fail, mediaTagName is too long");
            return false;
        } else if (this.messageAction != null && this.messageAction.length() > 2048) {
            Log.m4580e(TAG, "checkArgs fail, messageAction is too long");
            return false;
        } else if (this.messageExt == null || this.messageExt.length() <= 2048) {
            return this.mediaObject.checkArgs();
        } else {
            Log.m4580e(TAG, "checkArgs fail, messageExt is too long");
            return false;
        }
    }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m4580e(TAG, "setThumbImage exception:" + e.getMessage());
        }
    }
}
