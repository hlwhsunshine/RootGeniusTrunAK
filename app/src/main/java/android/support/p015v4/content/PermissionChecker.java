...
import android.support.p015v4.app.AppOpsManagerCompat;
...
public final class PermissionChecker {
    ...
    public static int checkCallingOrSelfPermission(@NonNull Context context, @NonNull String str) {
        return PermissionChecker.checkPermission(context, str, Binder.getCallingPid(), Binder.getCallingUid(), Binder.getCallingPid() == Process.myPid() ? context.getPackageName() : null);
    }

    public static int checkCallingPermission(@NonNull Context context, @NonNull String str, String str2) {
        return Binder.getCallingPid() == Process.myPid() ? -1 : PermissionChecker.checkPermission(context, str, Binder.getCallingPid(), Binder.getCallingUid(), str2);
    }
