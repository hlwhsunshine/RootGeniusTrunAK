...
import android.support.p015v4.view.NestedScrollingChild;
import android.support.p015v4.view.NestedScrollingChildHelper;
import android.support.p015v4.view.NestedScrollingParent;
import android.support.p015v4.view.NestedScrollingParentHelper;
import android.support.p015v4.view.ScrollingView;
...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild, NestedScrollingParent, ScrollingView {
    ...
    static class SavedState extends BaseSavedState {
        ...
        final class C02031 implements Creator<SavedState> {
            C02031() {
            }
        ...
        if (canScroll()) {
            ...
            if (keyEvent.getAction() == 0) {
                switch (keyEvent.getKeyCode()) {
                    ...
                    case 20:
                        if (!keyEvent.isAltPressed()) {
                            arrowScroll = arrowScroll(TransportMediator.KEYCODE_MEDIA_RECORD);
                            break;
                        }
                        arrowScroll = fullScroll(TransportMediator.KEYCODE_MEDIA_RECORD);
                        break;
                    case 62:
