...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00902();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00891();
    ...
    class C00902 implements OnItemClickListener {
        C00902() {
        }
