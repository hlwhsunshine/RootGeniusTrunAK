package com.tencent.p105mm.opensdk.modelpay;

import android.os.Bundle;
import com.tencent.p105mm.opensdk.modelbase.BaseReq;
import com.tencent.p105mm.opensdk.utils.C1672a;
...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C1672a.m4585b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C1672a.m4584a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public boolean checkArgs() {
        if (this.appId == null || this.appId.length() == 0) {
            Log.m4580e(TAG, "checkArgs fail, invalid appId");
            return false;
        } else if (this.partnerId == null || this.partnerId.length() == 0) {
            Log.m4580e(TAG, "checkArgs fail, invalid partnerId");
            return false;
        } else if (this.prepayId == null || this.prepayId.length() == 0) {
            Log.m4580e(TAG, "checkArgs fail, invalid prepayId");
            return false;
        } else if (this.nonceStr == null || this.nonceStr.length() == 0) {
            Log.m4580e(TAG, "checkArgs fail, invalid nonceStr");
            return false;
        } else if (this.timeStamp == null || this.timeStamp.length() == 0) {
            Log.m4580e(TAG, "checkArgs fail, invalid timeStamp");
            return false;
        } else if (this.packageValue == null || this.packageValue.length() == 0) {
            Log.m4580e(TAG, "checkArgs fail, invalid packageValue");
            return false;
        } else if (this.sign == null || this.sign.length() == 0) {
            Log.m4580e(TAG, "checkArgs fail, invalid sign");
            return false;
        } else if (this.extData == null || this.extData.length() <= 1024) {
            return true;
        } else {
            Log.m4580e(TAG, "checkArgs fail, extData length too long");
            return false;
        }
    }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C1672a.m4585b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C1672a.m4585b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C1672a.m4585b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C1672a.m4585b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C1672a.m4585b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C1672a.m4585b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C1672a.m4585b(bundle, "_wxapi_payreq_sign");
        this.extData = C1672a.m4585b(bundle, "_wxapi_payreq_extdata");
        this.signType = C1672a.m4585b(bundle, "_wxapi_payreq_sign_type");
