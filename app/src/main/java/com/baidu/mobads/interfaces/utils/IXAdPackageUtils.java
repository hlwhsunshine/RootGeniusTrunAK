    ...
    public static class ApkInfo {
        ...
        public JSONObject toJSONObject() {
            ...
            try {
                ...
                jSONObject.put(IXAdRequestInfo.f650V, this.versionName);
                jSONObject.put("c", this.versionCode);
                jSONObject.put("s", new File(this.f654a.applicationInfo.sourceDir).lastModified());
