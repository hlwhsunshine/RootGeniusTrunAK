...
public class WXImageObject implements IMediaObject {
    ...
    public WXImageObject(Bitmap bitmap) {
        try {
            ...
            Log.m4580e(TAG, "WXImageObject <init>, exception:" + e.getMessage());
        }
    }
