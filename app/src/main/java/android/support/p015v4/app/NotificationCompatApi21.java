...
import android.support.p015v4.app.NotificationCompatBase.UnreadConversation.Factory;
...
class NotificationCompatApi21 {
    ...
    public static class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        /* renamed from: b */
        private android.app.Notification.Builder f134b;
    ...
    static Bundle getBundleForUnreadConversation(UnreadConversation unreadConversation) {
        ...
        if (remoteInput != null) {
            bundle.putParcelable(KEY_REMOTE_INPUT, NotificationCompatApi21.fromCompatRemoteInput(remoteInput));
        }
    ...
    static UnreadConversation getUnreadConversationFromBundle(Bundle bundle, Factory factory, RemoteInputCompatBase.RemoteInput.Factory factory2) {
        ...
        return factory.build(strArr, remoteInput != null ? NotificationCompatApi21.toCompatRemoteInput(remoteInput, factory2) : null, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
    }
