        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (TAG_ROOT_PATH.equals(name)) {
                    buildPath = FileProvider.buildPath(DEVICE_ROOT, attributeValue2);
                } else if (TAG_FILES_PATH.equals(name)) {
                    buildPath = FileProvider.buildPath(context.getFilesDir(), attributeValue2);
                } else if (TAG_CACHE_PATH.equals(name)) {
                    buildPath = FileProvider.buildPath(context.getCacheDir(), attributeValue2);
                } else if (TAG_EXTERNAL.equals(name)) {
                    buildPath = FileProvider.buildPath(Environment.getExternalStorageDirectory(), attributeValue2);
                } else {
                    buildPath = null;
                }
                if (buildPath != null) {
