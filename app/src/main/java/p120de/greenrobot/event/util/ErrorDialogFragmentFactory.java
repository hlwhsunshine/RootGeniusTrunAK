...
public abstract class ErrorDialogFragmentFactory<T> {
    ...
    public static class Honeycomb extends ErrorDialogFragmentFactory<Fragment> {
        ...
        protected Fragment createErrorFragment(ThrowableFailureEvent throwableFailureEvent, Bundle bundle) {
            Fragment honeycomb = new p120de.greenrobot.event.util.ErrorDialogFragments.Honeycomb();
    ...
    public static class Support extends ErrorDialogFragmentFactory<android.support.p015v4.app.Fragment> {
        public Support(ErrorDialogConfig errorDialogConfig) {
            super(errorDialogConfig);
        }

        protected android.support.p015v4.app.Fragment createErrorFragment(ThrowableFailureEvent throwableFailureEvent, Bundle bundle) {
            android.support.p015v4.app.Fragment support = new p120de.greenrobot.event.util.ErrorDialogFragments.Support();
