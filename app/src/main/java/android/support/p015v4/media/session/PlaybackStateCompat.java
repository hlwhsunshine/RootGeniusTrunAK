...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01491();
    ...
    final class C01491 implements Creator<PlaybackStateCompat> {
        C01491() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01501();
        ...
        final class C01501 implements Creator<CustomAction> {
            C01501() {
            }
        ...
        /* synthetic */ CustomAction(Parcel parcel, C01491 c01491) {
            this(parcel);
        }
        ...
        /* synthetic */ CustomAction(String str, CharSequence charSequence, int i, Bundle bundle, C01491 c01491) {
        ...
        public static CustomAction fromCustomAction(Object obj) {
            ...
            CustomAction customAction = new CustomAction(android.support.p015v4.media.session.PlaybackStateCompatApi21.CustomAction.getAction(obj), android.support.p015v4.media.session.PlaybackStateCompatApi21.CustomAction.getName(obj), android.support.p015v4.media.session.PlaybackStateCompatApi21.CustomAction.getIcon(obj), android.support.p015v4.media.session.PlaybackStateCompatApi21.CustomAction.getExtras(obj));
        ...
        public final Object getCustomAction() {
            ...
            this.mCustomActionObj = android.support.p015v4.media.session.PlaybackStateCompatApi21.CustomAction.newInstance(this.mAction, this.mName, this.mIcon, this.mExtras);
            return this.mCustomActionObj;
        }
    ...
    /* synthetic */ PlaybackStateCompat(int i, long j, long j2, float f, long j3, CharSequence charSequence, long j4, List list, long j5, Bundle bundle, C01491 c01491) {
    ...
    /* synthetic */ PlaybackStateCompat(Parcel parcel, C01491 c01491) {
        this(parcel);
    }
