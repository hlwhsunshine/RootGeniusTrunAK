...
import android.support.p015v4.view.animation.FastOutSlowInInterpolator;
...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C02023();
    boolean mFinishing;
    ...
    class C02023 implements Callback {
        C02023() {
        }
    ...
    private void setupAnimators() {
        ...
        Animation c02001 = new Animation() {
        ...
        c02001.setRepeatCount(-1);
        c02001.setRepeatMode(1);
        c02001.setInterpolator(LINEAR_INTERPOLATOR);
        c02001.setAnimationListener(new AnimationListener() {
