...
class MediaSessionCompatApi23 {
    ...
    public interface Callback extends android.support.p015v4.media.session.MediaSessionCompatApi21.Callback {
        void onPlayFromUri(Uri uri, Bundle bundle);
    }

    /* renamed from: android.support.v4.media.session.MediaSessionCompatApi23$CallbackProxy */
    static class CallbackProxy<T extends Callback> extends android.support.p015v4.media.session.MediaSessionCompatApi21.CallbackProxy<T> {
