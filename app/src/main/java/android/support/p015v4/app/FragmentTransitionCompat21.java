...
class FragmentTransitionCompat21 {
    ...
    public static void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            while (i < transitionCount) {
                FragmentTransitionCompat21.addTargets(transitionSet.getTransitionAt(i), arrayList);
                i++;
            }
    ...
    public static void addTransitionTargets(Object obj, Object obj2, View view, ViewRetriever viewRetriever, View view2, EpicenterView epicenterView, Map<String, String> map, ArrayList<View> arrayList, Map<String, View> map2, Map<String, View> map3, ArrayList<View> arrayList2) {
        if (obj != null || obj2 != null) {
            ...
            if (obj2 != null) {
                FragmentTransitionCompat21.setSharedElementTargets(obj2, view2, map2, arrayList2);
            }
    ...
    private static void bfsAddViewChildren(List<View> list, View view) {
        int size = list.size();
        if (!FragmentTransitionCompat21.containedBeforeIndex(list, view, size)) {
            list.add(view);
            for (int i = size; i < list.size(); i++) {
                ...
                if (view2 instanceof ViewGroup) {
                    ...
                    for (int i2 = 0; i2 < childCount; i2++) {
                        ...
                        if (!FragmentTransitionCompat21.containedBeforeIndex(list, childAt, size)) {
                            list.add(childAt);
                        }
                    }
                }
    ...
    private static void captureTransitioningViews(ArrayList<View> arrayList, View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            for (int i = 0; i < childCount; i++) {
                FragmentTransitionCompat21.captureTransitioningViews(arrayList, viewGroup.getChildAt(i));
            }
            return;
        }
        arrayList.add(view);
    ...
    public static void findNamedViews(Map<String, View> map, View view) {
        if (view.getVisibility() == 0) {
            ...
            if (view instanceof ViewGroup) {
                ...
                int childCount = viewGroup.getChildCount();
                for (int i = 0; i < childCount; i++) {
                    FragmentTransitionCompat21.findNamedViews(map, viewGroup.getChildAt(i));
                }
            }
        }
    }
    ...
    public static void removeTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            for (int i = 0; i < transitionCount; i++) {
                FragmentTransitionCompat21.removeTargets(transitionSet.getTransitionAt(i), arrayList);
            }
    ...
    public static void setEpicenter(Object obj, View view) {
        Transition transition = (Transition) obj;
        final Rect boundsOnScreen = FragmentTransitionCompat21.getBoundsOnScreen(view);
    ...
    public static void setSharedElementTargets(Object obj, View view, Map<String, View> map, ArrayList<View> arrayList) {
        ...
        int size = arrayList.size();
        for (int i = 0; i < size; i++) {
            FragmentTransitionCompat21.bfsAddViewChildren(targets, (View) arrayList.get(i));
        }
        arrayList.add(view);
        FragmentTransitionCompat21.addTargets(transitionSet, arrayList);
    }
