...
public class ContextCompat {
    ...
    public static File getCodeCacheDir(Context context) {
        return VERSION.SDK_INT >= 21 ? ContextCompatApi21.getCodeCacheDir(context) : ContextCompat.createFilesDir(new File(context.getApplicationInfo().dataDir, "code_cache"));
    }
    ...
    public static File[] getExternalCacheDirs(Context context) {
        ...
        if (i >= 8) {
            ...
            externalCacheDir = ContextCompat.buildPath(Environment.getExternalStorageDirectory(), DIR_ANDROID, DIR_DATA, context.getPackageName(), DIR_CACHE);
        }
    ...
    public static File[] getExternalFilesDirs(Context context, String str) {
        ...
        if (i >= 8) {
            ...
            externalFilesDir = ContextCompat.buildPath(Environment.getExternalStorageDirectory(), DIR_ANDROID, DIR_DATA, context.getPackageName(), DIR_FILES, str);
        }
    ...
    public static File[] getObbDirs(Context context) {
        ...
        if (i >= 11) {
            ...
            obbDir = ContextCompat.buildPath(Environment.getExternalStorageDirectory(), DIR_ANDROID, DIR_OBB, context.getPackageName());
        }
        return new File[]{obbDir};
    }

    public static boolean startActivities(Context context, Intent[] intentArr) {
        return ContextCompat.startActivities(context, intentArr, null);
    }
    ...
    public final File getNoBackupFilesDir(Context context) {
        return VERSION.SDK_INT >= 21 ? ContextCompatApi21.getNoBackupFilesDir(context) : ContextCompat.createFilesDir(new File(context.getApplicationInfo().dataDir, "no_backup"));
    }
}
