...
import android.support.p015v4.view.accessibility.AccessibilityNodeInfoCompatKitKat.CollectionInfo;
import android.support.p015v4.view.accessibility.AccessibilityNodeInfoCompatKitKat.CollectionItemInfo;
import android.support.p015v4.view.accessibility.AccessibilityNodeInfoCompatKitKat.RangeInfo;
...
public class AccessibilityNodeInfoCompat {
    ...
    public static AccessibilityNodeInfoCompat obtain(View view, int i) {
        return AccessibilityNodeInfoCompat.wrapNonNullInstance(IMPL.obtain(view, i));
    }
    ...
    public AccessibilityNodeInfoCompat findFocus(int i) {
        return AccessibilityNodeInfoCompat.wrapNonNullInstance(IMPL.findFocus(this.mInfo, i));
    }

    public AccessibilityNodeInfoCompat focusSearch(int i) {
        return AccessibilityNodeInfoCompat.wrapNonNullInstance(IMPL.focusSearch(this.mInfo, i));
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int i) {
        return AccessibilityNodeInfoCompat.wrapNonNullInstance(IMPL.getChild(this.mInfo, i));
    }
