...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        if (i != 0) {
            floor = TimeUtils.accumField(i2, 1, false, 0);
            floor += TimeUtils.accumField(i4, 1, floor > 0, 2);
            floor += TimeUtils.accumField(i6, 1, floor > 0, 2);
            floor += TimeUtils.accumField(i7, 1, floor > 0, 2);
            i5 = 0;
            i3 = (TimeUtils.accumField(i8, 2, true, floor > 0 ? 3 : 0) + 1) + floor;
            while (i3 < i) {
                cArr[i5] = ' ';
                i3++;
                i5++;
        ...
        int printField = TimeUtils.printField(cArr, i2, 'd', i5, false, 0);
        printField = TimeUtils.printField(cArr, i4, 'h', printField, printField != i5, obj != null ? 2 : 0);
        printField = TimeUtils.printField(cArr, i6, 'm', printField, printField != i5, obj != null ? 2 : 0);
        int printField2 = TimeUtils.printField(cArr, i7, 's', printField, printField != i5, obj != null ? 2 : 0);
        floor = (obj == null || printField2 == i5) ? 0 : 3;
        i2 = TimeUtils.printField(cArr, i8, 'm', printField2, true, floor);
        cArr[i2] = 's';
        return i2 + 1;
    }
