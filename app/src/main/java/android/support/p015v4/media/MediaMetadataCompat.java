...
import android.support.p015v4.media.MediaDescriptionCompat.Builder;
...
public final class MediaMetadataCompat implements Parcelable {
    public static final Creator<MediaMetadataCompat> CREATOR = new C01291();
    ...
    final class C01291 implements Creator<MediaMetadataCompat> {
        C01291() {
        }
