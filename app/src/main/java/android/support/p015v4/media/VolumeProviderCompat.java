...
import android.support.p015v4.media.VolumeProviderCompatApi21.Delegate;
...
public abstract class VolumeProviderCompat {
    ...
    class C01391 implements Delegate {
        C01391() {
        }
    ...
    public Object getVolumeProvider() {
        ...
        this.mVolumeProviderObj = VolumeProviderCompatApi21.createVolumeProvider(this.mControlType, this.mMaxVolume, this.mCurrentVolume, new C01391());
        return this.mVolumeProviderObj;
    }
