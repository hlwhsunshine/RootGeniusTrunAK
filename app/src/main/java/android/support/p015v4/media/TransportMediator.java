...
public class TransportMediator extends TransportController {
    ...
    class C01311 implements TransportMediatorCallback {
        C01311() {
        }
    ...
    class C01322 implements Callback {
        C01322() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C01311();
        this.mKeyEventCallback = new C01322();
