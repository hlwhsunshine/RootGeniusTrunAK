...
class NotificationCompatJellybean {
    ...
    public static class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f136b, action));
        }

        public Notification build() {
            Notification build = this.f136b.build();
    ...
    public static Action getAction(Notification notification, int i, Factory factory, RemoteInput.Factory factory2) {
        ...
        synchronized (sActionsLock) {
            try {
                Bundle bundle;
                Object obj = NotificationCompatJellybean.getActionObjectsLocked(notification)[i];
                ...
                if (extras != null) {
                    ...
                    if (sparseParcelableArray != null) {
                        ...
                        readAction = NotificationCompatJellybean.readAction(factory, factory2, sActionIconField.getInt(obj), (CharSequence) sActionTitleField.get(obj), (PendingIntent) sActionIntentField.get(obj), bundle);
                    }
                }
                bundle = null;
                readAction = NotificationCompatJellybean.readAction(factory, factory2, sActionIconField.getInt(obj), (CharSequence) sActionTitleField.get(obj), (PendingIntent) sActionIntentField.get(obj), bundle);
    ...
    public static Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> arrayList, Factory factory, RemoteInput.Factory factory2) {
        ...
        while (true) {
            ...
            newArray[i2] = NotificationCompatJellybean.getActionFromBundle((Bundle) arrayList.get(i2), factory, factory2);
            i = i2 + 1;
        }
    }
    ...
    public static ArrayList<Parcelable> getParcelableArrayListForActions(Action[] actionArr) {
        ...
        for (Action bundleForAction : actionArr) {
            arrayList.add(NotificationCompatJellybean.getBundleForAction(bundleForAction));
        }
        return arrayList;
    }
