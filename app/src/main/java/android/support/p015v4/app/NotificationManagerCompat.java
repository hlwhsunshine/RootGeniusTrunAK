...
import android.support.p015v4.app.INotificationSideChannel.Stub;
...
public final class NotificationManagerCompat {
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f138id, this.tag);
            }
        }
        ...
        public String toString() {
            ...
            stringBuilder.append(", id:").append(this.f138id);
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f139id, this.tag, this.notif);
        }

        public String toString() {
            StringBuilder stringBuilder = new StringBuilder("NotifyTask[");
            stringBuilder.append("packageName:").append(this.packageName);
            stringBuilder.append(", id:").append(this.f139id);
            stringBuilder.append(", tag:").append(this.tag);
            stringBuilder.append("]");
            return stringBuilder.toString();
        }
