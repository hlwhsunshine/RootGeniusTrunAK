...
public class LuaState {
    private static final String LUAJAVA_LIB = "shuameluajava";
    ...
    public static final Integer LUA_REGISTRYINDEX = new Integer(MidConstants.ERROR_ARGUMENT);
    ...
    /* renamed from: gc */
    public int mo9146gc(int i, int i2) {
    ...
    public LuaObject getLuaObject(LuaObject luaObject, Number number) {
        if (luaObject.f5844L.getCPtrPeer() == this.luaState.getPeer()) {
